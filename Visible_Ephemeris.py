...
# ---------------------------------------------------------------------------
# Web UI template (Server-Sent Events)
# ---------------------------------------------------------------------------
...
def build_parser() -> argparse.ArgumentParser:
    ...
    ap.add_argument("--twilight", type=str, default="civil",
                    ...
                    help="twilight model for night definition")
    ...
    ap.add_argument("--max-apogee", type=float, default=500.0,
                    help="maximum apogee altitude in km (default 500 km)")
...
def main() -> None:
    ...
    try:
        while True:
            ...
            # Sun altitude at observer; decide if it's night
